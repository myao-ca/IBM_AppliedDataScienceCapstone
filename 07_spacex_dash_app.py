...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        site_success_rate = df_success['Launch Site'].value_counts().reset_index()
        site_success_rate.columns = ['Launch Site','Count']
        fig = px.pie(site_success_rate, names='Launch Site', values='Count',
                     title='Success Rate for Each Launch Site')
        return fig
    else:
        site_filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        vc_site = site_filtered_df['class'].value_counts().reset_index()
        vc_site.columns = ['class', 'Count']
        fig = px.pie(vc_site, names='class', values = 'Count',
